...
echo "replace github.com/fodedoumbouya/agent-sdk-go => ${REPO_ROOT}" >> go.mod
go mod tidy
...
echo "Visit https://goreportcard.com/report/github.com/fodedoumbouya/agent-sdk-go to see your score." 